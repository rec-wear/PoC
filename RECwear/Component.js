	...
	metadata: {
		routing: {
			...
			routes: [{
				...
				pattern: "1445915820018_S0/1445915820019_S1",
				name: "1445915820019_S1",
				target: ["1445915820018_S0", "1445915820019_S1"]
			}, {
				pattern: "1445915820018_S0/1445917074760_S2",
				name: "1445917074760_S2",
				target: ["1445915820018_S0", "1445917074760_S2"]
			}, {
				pattern: "1445915820018_S0/1445917078454_S3",
				name: "1445917078454_S3",
				target: ["1445915820018_S0", "1445917078454_S3"]
			}, {
			...
			{ pattern: "1445915820018_S0/1445932712213_S0",
				...
				target: ["1445915820018_S0", "1445932712213_S0"]
			}],
			targets: {
				"1445915820018_S0": {
				...
				"1445915820019_S1": {
					controlAggregation: "detailPages",
					viewName: "1445915820019_S1",
					viewId: "1445915820019_S1",
					viewLevel: "2"
				},
				"1445917074760_S2": {
					controlAggregation: "detailPages",
					viewName: "1445917074760_S2",
					viewId: "1445917074760_S2",
					viewLevel: "2"
				},
				"1445917078454_S3": {
					controlAggregation: "detailPages",
					viewName: "1445917078454_S3",
					viewId: "1445917078454_S3",
					viewLevel: "2"
				},
				"1445917138693_S4": {
					controlAggregation: "detailPages",
